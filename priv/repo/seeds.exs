...
Repo.insert!(%Episode{
  headline: "Hvorfor er Eva Kjer Hansen stadig minister? // Regeringen og Eva Kjer Hansen fortsætter.",
...
Repo.insert!(%Episode{
  headline: "Hvorfor har Danmark fået sin første restaurant med tre Michelin-stjerner // Danmark har fået sin første restaurant med tre Michelin-stjerner.",
...
Repo.insert!(%Episode{
  headline: "Hvorfor skal Melodi Gran Prix's point uddelere coaches? // Pointuddelere til Melodi Gran Prix skal coaches",
